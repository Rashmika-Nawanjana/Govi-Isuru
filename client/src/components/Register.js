...
const Register = ({ onRegisterSuccess, switchToLogin, lang }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!passwordValidation.isValid) {
      setError(lang === 'si' ? 'මුරපදය සියලු අවශ්‍යතා සපුරා ඇතිවිය යුතුය' : 'Password must meet all requirements');
      setLoading(false);
      return;
    }

    if (formData.password !== formData.confirmPassword) {
      setError(lang === 'si' ? 'මුරපද ගැලපෙන්නේ නැත' : 'Passwords do not match');
      setLoading(false);
      return;
    }
  ...
  const labels = {
    ...
    si: {
      selectRole: 'මම',
      farmer: 'ගොවියෙක්',
      officer: 'රජ නිලධාරියෙක්',
      buyer: 'ක්‍රේතෙක්',
      fullName: 'සම්පූර්ණ නම',
      fullNamePlaceholder: 'උදා: නමල් පෙරේරා',
      username: 'ලිපිනය නම',
      usernamePlaceholder: 'උදා: namal_perera',
      email: 'විද්‍යුත් තැපැල් ලිපිනය',
      emailPlaceholder: 'your@email.com',
      phone: 'සම්බන්ධ කරන ලද ඇමතුම් අංකය',
      phonePlaceholder: 'උදා: +94771234567',
      password: 'මුරපදය',
      confirmPassword: 'මුරපදය යළි ඇතුළු කරන්න',
      passwordRequirements: {
        title: 'මුරපදය අඩුම වශයෙන් අයින්:',
        minLength: 'අවම වශයෙන් 8 ට',
        uppercase: 'එක් සිටුවුම් අකුරු',
        lowercase: 'එක් කුඩා අකුරු',
        number: 'එක් අංකයක්',
        special: 'එක් විශේෂ සංකේතයක් (!@#$%^&*)'
      },
      passwordStrength: {
        weak: 'දුර්වල',
        medium: 'මධ්‍යම',
      ...
      passwordsNoMatch: 'මුරපද ගැලපෙන්නේ නැත',
      district: 'දිස්ත්‍රික්කුව',
      dsDivision: 'ඩිස්ට්‍රික්ට් ශ්‍රී විභාගය',
      gnDivision: 'ග්‍රාම නිලධාරි බිම්බතුන',
      officerId: 'නිලධාරී අංකය',
      officerIdPlaceholder: 'උදා: AGR/2024/001',
      department: 'අංශය',
      departmentPlaceholder: 'උදා: කෘෂිකර්ම අංශය',
      designation: 'තනතුර',
      designationPlaceholder: 'උදා: කෘෂිකර්ම උපදේශක',
      register: 'ගිණුම සාදන්න',
      haveAccount: 'ඔබ දැනටමත් ගිණුමක් ඇත',
      login: 'ඉතින් ඉවතට පිවිසෙන්න',
      verifyEmailTitle: 'ඔබගේ විද්‍යුත් තැපැල පිරික්සන්න',
      verifyEmailMessage: 'අපි ඔබගේ විද්‍යුත් තැපැල වලට සැබුතා සම්බන්ධතාවයක් සිටිර්න',
      checkInbox: 'කරුණාකර ඔබගේ ඊන්බොක්ස ඉතින් පිරික්සන්න සිට සැබුතා සම්බන්ධතාවයක් ඔබගේ ගිණුම සිතිර්න.',
      checkSpam: 'එය දැකගිය නොහැකි නම්, ඔබගේ අපඩුත ෂකර් පිරික්සන්න.',
      goToLogin: 'පිවිසෙන ගිණුමට යාම',
      resendEmail: 'සැබුතා සම්බන්ධතා විද්‍යුත් තැපැල නැවත යැවීම'
    }
  };
